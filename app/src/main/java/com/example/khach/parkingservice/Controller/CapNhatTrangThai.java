...
public class CapNhatTrangThai extends ActionBarActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.updatestateparking);
        myData = FirebaseDatabase.getInstance().getReference();
        spnVehicle = (Spinner)findViewById(R.id.spnVehicleTypeEdit);
        ...
        myData.child("DetailFeeParking").equalTo("abc").addValueEventListener(new ValueEventListener() {
            @Override
